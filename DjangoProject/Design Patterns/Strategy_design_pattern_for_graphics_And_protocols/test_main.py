...
x = 1000
j = 0
contor_afisare_prost = 0
contor_afisare_buna = 0
while j < 100:
    ...
    if final_result_decrypted != x % a:
        contor_afisare_prost += 1
    else:
        contor_afisare_buna += 1
    j += 1
    print("c value: " + str(c) + " final: " + str(final_result_decrypted))

print(r)
print(contor_afisare_prost)
print(contor_afisare_buna)
